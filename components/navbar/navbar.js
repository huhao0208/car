Component({
    ...
    attached() {
        ...
        console.log(pages.slice(-1)[0].route)
        if (pages.slice(-1)[0].route =='pages/home/index') return this.setData({
            back:false,
            home:false
        })
        if(pages.length<2) {
    ...
    methods: {
        setStyle(life) {
            ...
            if ((back && !home) || (!back && home)) {
                navBarLeft = [`width:${capsulePosition.width/2}px`, `height:${capsulePosition.height}px`].join(';')
